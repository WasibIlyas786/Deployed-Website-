...
export const content = {
    ...
    service_content: [
      {
        ...
        para: "We specialize in frontend development, transforming your design visions into captivating web experiences. With expertise in HTML, CSS, and JavaScript, we create visually appealing and interactive interfaces that engage your audience and leave a lasting impression.",
        logo: services_logo1,
      },
      {
        title: "Backend Development",
        para: "Our backend development expertise empowers your web applications with seamless functionality. Leveraging technologies like Node.js and databases such as MongoDB, we build robust and scalable backend systems that handle complex tasks and ensure smooth operations.",
        logo: services_logo2,
      },
      {
        title: "Data Science",
        para: "Our data science solutions unlock valuable insights from your data, driving business success and informed decision-making. With expertise in data analysis, machine learning, and predictive modeling, we help you harness the power of data to gain a competitive edge and achieve your goals.",
        logo: services_logo4,
      },
    ],
  },
  ...
  Hireme: {
    ...
    para: "Need web development services? Look no further! We offer front-end, back-end, and full-stack development solutions. Whether you require a stunning user interface, robust server-side functionality, or a complete end-to-end solution, our team has you covered. Contact us today for a consultation or to discuss your project requirements. Let us bring your web development vision to life",
    btnText: "Hire Me",
  },
  Contact: {
    title: "Contect Me",
